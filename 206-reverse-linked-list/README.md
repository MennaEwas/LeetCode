...
<pre style="user-select: auto; position: relative;"><strong style="user-select: auto;">Input:</strong> head = [1,2,3,4,5]
...
<pre style="user-select: auto; position: relative;"><strong style="user-select: auto;">Input:</strong> head = [1,2]
<strong style="user-select: auto;">Output:</strong> [2,1]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper" style="user-select: auto;"></div></pre>

<p style="user-select: auto;"><strong style="user-select: auto;">Example 3:</strong></p>

<pre style="user-select: auto; position: relative;"><strong style="user-select: auto;">Input:</strong> head = []
